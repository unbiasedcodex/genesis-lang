...
impl<'ctx> LLVMCodegen<'ctx> {
    ...
    fn convert_type(&self, ty: &IrType) -> Option<BasicTypeEnum<'ctx>> {
        match ty {
            ...
            IrType::I8 | IrType::U8 => Some(self.context.i8_type().into()),
            IrType::I16 | IrType::U16 => Some(self.context.i16_type().into()),
            IrType::I32 | IrType::U32 => Some(self.context.i32_type().into()),
            IrType::I64 | IrType::U64 => Some(self.context.i64_type().into()),
